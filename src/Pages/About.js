        ...
        return (
            <article className="content-wrap section_space-v_l">
                <section className="grid-container grid-container_about">
                    <div className="grid-container__section-xl tile_about">
                    ...
                    <div className="grid-container__section-m tile_about">
                    ...
                    <div className="grid-container__section-s tile_about">
